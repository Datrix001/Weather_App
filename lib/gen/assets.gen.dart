...
class $AssetsFontsGen {
  ...
  /// File path: assets/fonts/Inter_Italic.ttf
  String get interItalic => 'assets/fonts/Inter_Italic.ttf';

  /// File path: assets/fonts/Inter_Regular.ttf
  String get interRegular => 'assets/fonts/Inter_Regular.ttf';

  /// List of all assets
  List<String> get values => [interItalic, interRegular];
}
...
class $AssetsSvgGen {
  ...
  String get cloudy => 'assets/svg/cloudy.svg';
  ...
  /// File path: assets/svg/shade.svg
  String get shade => 'assets/svg/shade.svg';
